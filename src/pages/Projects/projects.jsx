            ...
            <Link href="https://taxi-app-login.vercel.app/" passHref={true} legacyBehavior={true}>
              <a target="_blank" rel="noopener noreferrer">
                <div className={styles.linkCard}>
                  ...
                  <p>Created a login and registration page for Taxi using Next.js 13. Inside the registration page, there are fields for name, email, password, phone number, state, and city. You have used a library called &quot;geo location&quot; which can determine the user&apos;s state and city based on their location. I&apos;ve have also utilized MongoDB, which is a NoSQL database. MongoDB allows for easy storage, retrieval, and manipulation of data.     </p>
                </div>
              </a>
            </Link>
            <Link href="https://taxi-app-login.vercel.app/" passHref={true} legacyBehavior={true}>
              <a target="_blank" rel="noopener noreferrer">
                <div className={styles.linkCard}>
                  ...
                  <h3>Hassfilx</h3>
                  <p>Created a background video for the login and image for registration page for Hassfilx using Next.js 13. </p>
                </div>
              </a>
            </Link>
